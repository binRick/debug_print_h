...
char * pre_pad_string(char *s0){
  char *s1 = malloc((sizeof(char) * 1024) + 1);
...
void debug_print_printf_specifier(const char *expr, void *data,
  ...
  char *expr1 = pre_pad_string(expr);

  snprintf(format_string, 1024,
           "👽" AC_RESETALL
           " " AC_RESETALL
           "%s" AC_RESETALL
           "[" AC_RESETALL
